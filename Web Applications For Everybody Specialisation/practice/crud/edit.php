...
if ( isset($_POST['name']) && isset($_POST['email']) //enter with get req
    ...
    $sql = "UPDATE users SET name = :name,
            ...
            WHERE user_id = :user_id"; // column = placeholder.
    ...
    $_SESSION['success'] = 'Record updated'; // flash message
...
if ( ! isset($_GET['user_id']) ) {
  $_SESSION['error'] = "Missing user_id"; //error variable is a flash
...
if ( $row === false ) {
    $_SESSION['error'] = 'Bad value for user_id'; //This code is from delete
...
$user_id = $row['user_id']; // no need to put html entities
//cuz you know that its always an integer.
?>
<p>Edit User</p>
<form method="post">
<p>Name:
<input type="text" name="name" value="<?= $n ?>"></p> <!--short hand for php code -->
<p>Email:
