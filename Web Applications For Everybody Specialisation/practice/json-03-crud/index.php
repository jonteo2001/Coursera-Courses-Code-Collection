<?php // the difference is that we will use JS with JQuery and
//pull the list of tracks using JSON
...
$.getJSON('getjson.php', function(rows) {
    ...
    for (var i = 0; i < rows.length; i++) {
        ...
        $("#mytab").append("<tr><td>"+htmlentities(row.title)+'</td><td>'
            ...
            + 'Delete</a>\n</td></tr>');
    }//This method allows you to dynamically update the rows without having
    //to hit refresh. When you view source, you will realise that the mytab is empty.
